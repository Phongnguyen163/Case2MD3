...
<div class="container-fluid" style="background: bisque">
    ...
    <div class="row">
        <div class="col-12 mt-3">
            <center>
                <p class="h2">XÓA SẢN PHẨM ĐANG BÁN</p>
            </center>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-12 mt-3">
                    <div class="card" style="width: 100%;">
                        <img src="${delete.img}" class="card-img-top" alt="...">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Tên Sản Phẩm: ${delete.name}</h5>
                            ...
                            <p class="card-text" >Giá: ${delete.price} VNĐ </p>
                            <p class="card-text" >Danh mục: ${delete.categoryzz.name}</p>

                            <form method="post">
                                <button class="btn btn-danger">Xóa Sản Phẩm Này</button>
                            </form>
                            <%--                                400.000 đ--%>
