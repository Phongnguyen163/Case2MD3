...
<%--                        </div>--%>
<%--&lt;%&ndash;                        <br>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <div class="row" style="width: 100%">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <div class="col-12" style="width: 100%">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <input type="number" class="form-control" placeholder="CATAGORYID" name="catagoryid">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <br>&ndash;%&gt;--%>
<%--                        <div class="row" style="width: 100%">--%>
